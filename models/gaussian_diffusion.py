...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        if model_name == 'diffusion':
            ...
            for num_repeat in num_mask:
                ...
                start_pix = (num_repeat % 128)*2
                direction = num_repeat // 128
                if direction == 1:
    ...
    def training_losses(self, model, input_img, trans_img, model_name, t, x_start_t=None, model_kwargs=None, noise=None):
        """
        ...
        if model_name == 'diffusion':
            ...
            start_pix = random.randint(0, 128) * 2
        ...
        loss = nn.L1Loss()
        target = trans_img
        terms["loss"] = 100 * loss(x_start_pred, target)
